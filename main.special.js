function items(ee,bb,tt)
 ...
 function addToCart(ee,ih,id,ip,im,it) {
	 ...
	 if(!localStorage.getItem('cartlist')) {
		 i = 0;
		  window.localStorage.setItem('cartlist','<div class="item">' + "<div class='ip' style='background-image:url("+ ip +");'>" + '</div><div class="itemd"><div class="ih">' + ih + '</div><div class="im">Quantity: ' + im + '</div><div class="it">Price: R' + it + '</div></div><div style="display:none" class="id">' + id + '</div></div>');
	 } else {
		 i++;
