...
{ 
  if(window.swap=="buying") {
      window.location ="http://request.bleedingedgelab.co.za/man.php?swap=" + window.swap + "&fullname=" + getValue('fullname') + "&email=" + getValue('email') + "&password=" + getValue('password') + "&streetaddress=" + getValue('streetaddress') + "&city=" + getValue('city') + "&province=" + getValue('province') + "&idnumber=" + getValue('idnumber') + "&units=" + getValue('units') + "&phone=" + getValue('phone') + "&postal=" + getValue('postal');
  } else if(window.swap=="login") {
          window.location ="http://request.bleedingedgelab.co.za/man.php?swap=" + window.swap + "&password=" + getValue('password') + "&email=" + getValue('email');
  
  } else if(window.swap=="quote") {
      
     window.location ="http://request.bleedingedgelab.co.za/man.php?swap=" + window.swap + "&fullname=" + getValue('fullname') + "&email=" + getValue('email') + "&phone=" + getValue('phone') + "&query=" + getValue('query');
  }
}
